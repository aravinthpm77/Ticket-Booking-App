...
const BusSearch = () => {
  ...
  return (
    <div className="flex items-center  rounded-full  max-w-3xl mx-auto ">
      
      <div className="flex items-center bg-slate-100 p-7 rounded-s-full pl-5 flex-grow ml-1 border-r border-gray-300">
      ...
      {/* Reverse Button */}
      <button
        className="bg-white border border-gray-300 w-12 h-12 justify-center items-center align-middle p-3 rounded-full absolute ml-[185px] hover:bg-slate-200 duration-300"
      ...
      <img width="20" height="20" src="https://img.icons8.com/small/50/bus.png" alt="bus"/>
        <input
          type="text"
