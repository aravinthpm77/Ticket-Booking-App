const busSeatData = [
  ...
  { id: 'B1',  status: 'available', price: 1600 },
  { id: 'B3',  status: 'available', price: 1600 },
  { id: 'B5',  status: 'booked',    price: 1600 },
  { id: 'B7',  status: 'available', price: 1600 },
  { id: 'B9',  status: 'available', price: 1600 },
  { id: 'B11', status: 'available', price: 1600 },
  { id: 'B13', status: 'booked',    price: 1600 },
  { id: 'B15', status: 'booked',    price: 1600 },
  { id: 'B17', status: 'available', price: 1600 },
 


  { id: 'B2',  status: 'available', price: 1600 },
  { id: 'B4',  status: 'available', price: 1600 },
  { id: 'B6',  status: 'available', price: 1600 },
  { id: 'B8',  status: 'booked',    price: 1600 },
  { id: 'B10', status: 'booked',    price: 1600 },
  { id: 'B12', status: 'available', price: 1600 },
  ...
  { id: 'A7',  status: 'available', price: 1600 },
  { id: 'A9',  status: 'available', price: 1600 },
  { id: 'A11', status: 'available', price: 1600 },
